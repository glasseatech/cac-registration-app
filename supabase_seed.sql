...
('guide.upsell_webinar_btn', 'Register Now', 'guide', 'Upsell CTA'),
...
('guide.upsell_ebook_btn', 'Access E-Book', 'guide', 'Upsell CTA'),
...
('guide.upsell_session_btn', 'Secure Your Spot', 'guide', 'Upsell CTA'),
...
('landing', 'proof', 'Proof & trust',
 ...
 '{"testimonials": [{"name": "Amaka • Lagos", "text": "I didn''t know where to start. The checklist and screenshots made everything straightforward, and support replied fast.", "quote": "Clear steps, no confusion.", "stars": 5}, {"name": "Mustapha • Abuja", "text": "I avoided common mistakes that cause delays. The guide is structured like an official process.", "quote": "Saved me time.", "stars": 5}, {"name": "Ifeoma • Enugu", "text": "For ₦5000 promo it''s a no-brainer. The updates also help because links and steps change.", "quote": "Worth it even at ₦7500.", "stars": 5}], "trustNoticeTitle": "Secure Payment via Paystack", "trustNoticeText": "Cards, bank transfer, USSD (options depend on Paystack settings)", "disclaimer": "This is an educational guide + support to help you complete your SMEDAN/CAC process correctly. We are not a government agency and do not issue certificates ourselves."}'::jsonb
),
...
('guide', 'upsell', 'Maximize Your Success',
 ...
 '{"items": [{"type": "webinar", "title": "Live Webinar", "description": "Ask questions live, see a sample registration, and network with others.", "price": "₦2,500", "btnText": "Register Now", "color": "blue"}, {"type": "ebook", "title": "DIY E-Book", "description": "A complete guide you can keep and revisit anytime for your business name.", "price": "₦2,500", "btnText": "Access E-Book", "color": "orange"}, {"type": "session", "title": "One-on-One Session", "description": "Get dedicated personal guidance from our team until your business is fully registered. No limitations, just bold results.", "price": "₦5,000", "btnText": "Secure Your Spot", "color": "dark"}]}'::jsonb
)

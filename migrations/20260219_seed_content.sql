...
BEGIN
  ...
  (v_intro_id, 'Getting Started', '<p>Kindly follow the guides below carefully and put your business in the face of the world for high profitability as you register your Business in few steps below:</p>', 2);

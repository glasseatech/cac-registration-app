          ...
          <div className="footer-grid grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div>
              ...
              <p style={{ marginTop: '6px' }}>
                {c('footer.whatsapp_label', 'WhatsApp:')}
                {(() => {
                  const wLink = cmsContent.contact?.whatsapp || c('footer.whatsapp_link', '2349161849691');
                  return (
                    <a href={wLink.startsWith('http') ? wLink : `https://wa.me/${wLink}`} target="_blank" rel="noopener noreferrer">
                      {c('footer.whatsapp_number', '+234 916 184 9691')}
                    </a>
                  );
                })()}
              </p>
